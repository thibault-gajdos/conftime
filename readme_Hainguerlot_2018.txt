*data_HainguerlotVergnaudDeGardelle_2018*

***Basic details about the experiment:
- Contributors: Marine Hainguerlot (hainguerlot@ese.eur.nl), Jean-Christophe Vergnaud (Jean-Christophe.Vergnaud@univ-paris1.fr) and Vincent de Gardelle (vincent.gardelle@gmail.com) 

- Citation: Hainguerlot, M., Vergnaud, J- C., & de Gardelle, V. (2018). Metacognitive ability predicts learning cue-stimulus associations in the absence of external feedback. Scientific reports, 8(1), 5602.
...
- Subject population: 65 individuals (28 females; mean +/- SD age, 22.31 +/- 3.12 years) 
...
- Experiment goal: We tested the prediction that, if no external feedback is available, then the participants' ability to learn about predictive cues should increase with the quality of their confidence judgments (i.e. metacognitive efficiency). 

- Main result: We tested this prediction using a perceptual decision task. We evaluated in separate sessions the metacognitive abilities of participants (in a 'confidence session') and their abilities to learn about predictive cues (in a 'learning session'). We found that participants with greater metacognitive abilities learned more about the cues. Furthermore, knowledge about the cues improved accuracy in the perceptual task (in the 'learning session'). 
...
- Link to material/ codes: http://dx.doi.org/10.1038/s41598-018-23936-9
...
--- About the experimental procedure: Participants came to two sessions, a 'confidence session' and a 'learning session', which took place 4 days apart. Both sessions started with a working memory test and an initial calibration phase. The order of the two sessions was counterbalanced across participants.   
...
--- About the coding of response time of decision below 200ms: Response times below 200ms (which concerns very few observations (0.26% of trials)) have not been properly saved. The variable RT_dec has been recoded= 0.2 for RT below 200ms.